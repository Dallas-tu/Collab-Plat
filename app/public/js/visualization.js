(function() {
    ...
    NetworkChannel = (function() {
      function NetworkChannel(up, onReceive) {
        ...
        this.button = $('<a href="#" class="disabled">' + arrow + '</a>').appendTo(this.el).click((function(_this) {
          return function(e) {
    ...
    MyClient = (function(superClass) {
      ...
      MyClient.prototype.setAwaitingAndBufferEdge = function(awaitingEdge, bufferEdge) {
        ...
        drawEdge = (function(_this) {
          return function(edge, color) {
